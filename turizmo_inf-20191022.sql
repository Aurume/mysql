...
--
-- Host: 127.0.0.1
-- Generation Time: 2019 m. Spa 22 d. 11:42
...
CREATE TABLE `imones` (
  ...
  `abbr` varchar(32) COLLATE utf8_lithuanian_ci NOT NULL,
  `pav` varchar(256) COLLATE utf8_lithuanian_ci NOT NULL,
  `rekvizitai` varchar(256) COLLATE utf8_lithuanian_ci NOT NULL,
  `veiklos_pobudis` varchar(256) COLLATE utf8_lithuanian_ci NOT NULL
...
INSERT INTO `imones` (`id`, `abbr`, `pav`, `rekvizitai`, `veiklos_pobudis`) VALUES
(1, 'mb', 'Kaimo turizmo sodyba PAS PAULIŲ.', 'Babilninkų k. 14,LT-33333, MOLĖTŲ RAJ., Lietuva.', 'sodyba-pas-pauliu-mb-sodyba-jusu-poilsiui-ir-sventei-moletu-rajone-babilninku-kaime-ant-virintu-ezero-kranto.'),
(2, 'uab', 'Turizmo paslaugos', 'A. Stulginskio g. 5-45, LT-01115 Vilnius', 'Kelionės'),
(3, 'uab', '„Šturmų žuvininkystės įmonė“', 'Minijos kaimas, Kintų seniūnija, Šilutės rajonas', 'Laivininkystė'),
(4, 'ab', 'Novaturas', 'A. Mickevičiaus g. 27 (Centras), 44245 Kaunas', 'Kelionių organizavimas');
...
(26, 'Trakai', '150.00', '53.0000000', '23.0000000', 1000);
...
CREATE TABLE `tipai` (
  `abbr` varchar(32) COLLATE utf8_lithuanian_ci NOT NULL,
  `abbr_lt` varchar(256) COLLATE utf8_lithuanian_ci NOT NULL,
  `pilnas_pav` varchar(256) COLLATE utf8_lithuanian_ci NOT NULL,
  `verslo_ypat` varchar(256) COLLATE utf8_lithuanian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_lithuanian_ci;
...
INSERT INTO `tipai` (`abbr`, `abbr_lt`, `pilnas_pav`, `verslo_ypat`) VALUES
('ab', 'ab', 'Kaimo turizmo sodyba PAS PAULIŲ.', 'Mažoji bendrija'),
('mb', 'Uždaroji akcinė bendrovė', 'Turizmo paslaugos', 'Uzdara akcine'),
('uab', 'uab', '„Šturmų žuvininkystės įmonė“', 'uabas');
...
--
-- Apribojimai lentelei `imones`
--
ALTER TABLE `imones`
  ADD CONSTRAINT `imones_ibfk_1` FOREIGN KEY (`abbr`) REFERENCES `tipai` (`abbr`) ON UPDATE CASCADE;
